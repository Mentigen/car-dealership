...
import CarDealership.domain.car.Part;
import CarDealership.domain.car.PartType;
...
class PartServiceTest {
  ...
  void testUpdateNonExistentPart() {
    Part newData = new Part(null, PartType.WHEEL, new BigDecimal("150"), List.of());
    assertThrows(
        EntityNotFoundException.class, () -> partService.updatePart(UUID.randomUUID(), newData));
  }

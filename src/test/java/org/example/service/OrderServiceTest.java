...
import org.example.domain.order.CustomOrder;
import org.example.domain.order.StockOrder;
...
class OrderServiceTest {
    ...
    public void setupCarData() {
        ...
        model.setEnginePower(184);
        model.setEngineVolume(2.0);
        model.setFuel(FuelType.PETROL);
        model.setBody(BodyType.SEDAN);
        model.setDrive(DriveType.RWD);
        model.setPrice(new BigDecimal("3000000"));

...
public class TestDriveService {
    ...
    public TestDriveRequest requestTestDrive(User client, UUID carId, LocalDateTime time) {
        TestDriveRequest request = new TestDriveRequest(UUID.randomUUID(), client, carId, time, new PendingState());

...
public class CarConfiguration {
    ...
    private static final List<PartType> REQUIRED_PART_TYPES = List.of(
            PartType.WHEEL, PartType.TRANSMISSION, PartType.STEERING_WHEEL, PartType.INTERIOR, PartType.COLOR
    );
    ...
    public BigDecimal getPrice() {
        BigDecimal partsPrice = parts.stream().map(Part::getPrice).reduce(BigDecimal.ZERO, BigDecimal::add);

...
public class CarConfigurationEntityMapper {
    ...
    public CarConfigurationEntityMapper(CarModelEntityMapper carModelMapper, PartEntityMapper partMapper) {
    ...
    public CarConfiguration toDomain(CarConfigurationEntity entity) {
        ...
        List<Part> parts = entity.getParts().stream().map(partMapper::toDomain).toList();
